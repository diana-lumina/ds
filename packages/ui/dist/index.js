...
import { Avatar as Avatar$1, Accordion, Select as Select$1, Popover, RadioGroup as RadioGroup$1, Checkbox as Checkbox$1, Switch as Switch$1, Tooltip as Tooltip$1, Dialog as Dialog$1, Progress } from 'radix-ui';
...
function Avatar({
  ...
  const [imageStatus, setImageStatus] = React12.useState(src ? "loading" : "idle");
  React12.useEffect(() => {
    ...
    Accordion.Root,
    {
      ...
      children: /* @__PURE__ */ jsxs(
        Accordion.Item,
        {
          ...
          className: cn(accordion_item_default.root, className),
          children: [
            /* @__PURE__ */ jsx(Accordion.Header, { className: accordion_item_default.header, children: /* @__PURE__ */ jsxs(
              Accordion.Trigger,
              {
                "data-slot": "accordion-item-trigger",
                className: accordion_item_default.trigger,
                children: [
                  icon ? /* @__PURE__ */ jsx("span", { "data-slot": "accordion-item-icon", className: accordion_item_default.leading, "aria-hidden": "true", children: icon }) : null,
                  /* @__PURE__ */ jsxs("span", { className: accordion_item_default.copy, children: [
                    /* @__PURE__ */ jsx("span", { className: accordion_item_default.title, children: title }),
                    supportingText ? /* @__PURE__ */ jsx("span", { className: accordion_item_default.supporting, children: supportingText }) : null
                  ] }),
                  /* @__PURE__ */ jsx("span", { className: accordion_item_default.caret, "aria-hidden": "true", children: /* @__PURE__ */ jsx(CaretDownIcon, {}) })
                ]
              }
            ) }),
            /* @__PURE__ */ jsx(
              Accordion.Content,
              {
                ...
                children: /* @__PURE__ */ jsx("div", { className: accordion_item_default.panel, children })
              }
            ),
            treatment === "plain" ? /* @__PURE__ */ jsx(Divider, { thickness: 1, className: accordion_item_default.divider }) : null
          ]
        }
      )
    }
...
function Stat({ value, label, icon, className, ...props }) {
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      className: cn(stat_default.root, className),
      ...props,
      children: [
        /* @__PURE__ */ jsx("span", { "data-slot": "stat-icon", className: stat_default.icon, "aria-hidden": "true", children: icon }),
        /* @__PURE__ */ jsxs("div", { className: stat_default.copy, children: [
          /* @__PURE__ */ jsx("p", { id: valueId, className: stat_default.value, children: value }),
          /* @__PURE__ */ jsx("p", { id: labelId, className: stat_default.label, children: label })
        ] })
      ]
    }
  );
...
function TableCell({ className, children, ...props }) {
  return /* @__PURE__ */ jsx("td", { "data-slot": "table-cell", className: cn(table_cell_default.root, className), ...props, children });
}
...
function TableHeaderCell({
  ...
  return /* @__PURE__ */ jsx(
    "th",
    {
      ...
      scope,
      className: cn(table_header_cell_default.root, className),
      ...props,
      children: /* @__PURE__ */ jsxs("button", { type: "button", className: table_header_cell_default.trigger, onClick, children: [
        /* @__PURE__ */ jsx("span", { className: table_header_cell_default.label, children: label }),
        icon ? /* @__PURE__ */ jsx("span", { "data-slot": "table-header-cell-icon", className: table_header_cell_default.icon, "aria-hidden": "true", children: icon }) : null
      ] })
    }
  );
}
...
function TableRow({
  ...
  return /* @__PURE__ */ jsx(
    "tr",
    {
      ...
      className: cn(table_row_default.root, className),
      ...props,
      children
    }
  );
...
function Table({ header, children, className, ...props }) {
  return /* @__PURE__ */ jsx("div", { "data-slot": "table", className: cn(table_default.frame, className), children: /* @__PURE__ */ jsxs("table", { className: table_default.table, ...props, children: [
    header ? /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsx("tr", { "data-slot": "table-header", children: header }) }) : null,
    children ? /* @__PURE__ */ jsx("tbody", { children }) : null
  ] }) });
}
...
function DataTableToolbar({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      className: cn(data_table_toolbar_default.root, className),
      ...props,
      children: [
        /* @__PURE__ */ jsx("div", { "data-slot": "data-table-toolbar-search", className: data_table_toolbar_default.search, children: search }),
        filters ? /* @__PURE__ */ jsx("div", { "data-slot": "data-table-toolbar-filters", className: data_table_toolbar_default.slot, children: filters }) : null,
        actions ? /* @__PURE__ */ jsx("div", { "data-slot": "data-table-toolbar-actions", className: data_table_toolbar_default.slot, children: actions }) : null,
        children
      ]
    }
  );
...
function withNavigationBarContext(children) {
  return React12.Children.map(children, (child) => {
    ...
    return React12.cloneElement(child, { context: "navigation-bar" });
  });
}
...
function Breadcrumb({
  ...
  const items = React12.Children.toArray(children).filter(Boolean);
  return /* @__PURE__ */ jsx(
    "nav",
    {
...
function Calendar({
  ...
  const [uncontrolledMonth, setUncontrolledMonth] = React12.useState(
  ...
  const weeks = React12.useMemo(() => buildWeeks(viewMonth), [viewMonth]);
  const labels = React12.useMemo(() => weekdayLabels(locale), [locale]);
...
function DatePicker({
  ...
  const fieldRef = React12.useRef(null);
  const [open, setOpen] = React12.useState(false);
  const [uncontrolled, setUncontrolled] = React12.useState(defaultValue);
...
function Combobox({
  ...
  const [query, setQuery] = React12.useState(() => optionLabel(options, selected));
  const [open, setOpen] = React12.useState(false);
  const [highlight, setHighlight] = React12.useState(0);
  const filtered = React12.useMemo(
...
function FileUploadItem({
  ...
  const primaryId = React12.useId();
  const secondaryId = React12.useId();
...
function FileUpload({
  ...
  const primaryId = React12.useId();
  const secondaryId = React12.useId();
  const supportingId = React12.useId();
  const isInverse = tone === "inverse";
  const dropTone = tone;
  const isItemsControlled = items != null;
  const [internalFiles, setInternalFiles] = React12.useState([]);
...
function withSideNavigationContext(children) {
  return React12.Children.map(children, (child) => {
    ...
    return React12.cloneElement(child, { context: "side-navigation" });
  });
}
...
function Tooltip({
  ...
  return /* @__PURE__ */ jsx(Tooltip$1.Provider, { delayDuration, children: /* @__PURE__ */ jsxs(
    Tooltip$1.Root,
    {
      open,
      defaultOpen,
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(Tooltip$1.Portal, { children: /* @__PURE__ */ jsx(
          Tooltip$1.Content,
          {
            ...
            side,
            sideOffset: 8,
            className: cn(tooltip_default.root, className),
            children: label
          }
        ) })
      ]
...
function OtpInput({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      "data-slot": "otp-input",
      "aria-label": ariaLabel,
      className: cn(otp_input_default.root, className),
      ...props,
      children: [
        name ? /* @__PURE__ */ jsx("input", { type: "hidden", name, value: current }) : null,
        cells.map((digit, index) => /* @__PURE__ */ jsx(
          "input",
          {
            ref: (node) => {
...
function Dialog({
  ...
  return /* @__PURE__ */ jsxs(
    Dialog$1.Root,
    {
      ...
      onOpenChange,
      children: [
        trigger ? /* @__PURE__ */ jsx(Dialog$1.Trigger, { asChild: true, children: trigger }) : null,
        /* @__PURE__ */ jsxs(Dialog$1.Portal, { children: [
          /* @__PURE__ */ jsx(Dialog$1.Overlay, { "data-slot": "dialog-overlay", className: dialog_default.overlay }),
          /* @__PURE__ */ jsxs(
            Dialog$1.Content,
            {
              "data-slot": "dialog",
  ...
  return /* @__PURE__ */ jsxs(
    Dialog$1.Root,
    {
      ...
      children: [
        trigger ? /* @__PURE__ */ jsx(Dialog$1.Trigger, { asChild: true, children: trigger }) : null,
        /* @__PURE__ */ jsxs(Dialog$1.Portal, { children: [
          /* @__PURE__ */ jsx(Dialog$1.Overlay, { "data-slot": "drawer-overlay", className: drawer_default.overlay }),
          /* @__PURE__ */ jsxs(
            Dialog$1.Content,
            {
              "data-slot": "drawer",
