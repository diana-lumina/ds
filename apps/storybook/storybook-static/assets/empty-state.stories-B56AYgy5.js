...
/>`}}},render:()=>(0,w.jsx)(b,{type:`error`,title:`No se pudo cargar`,message:`Ocurrió un problema al obtener la información. Inténtalo de nuevo.`,icon:(0,w.jsx)(s,{})})},A={parameters:{docs:{canvas:{sourceState:`shown`},source:{code:`<EmptyState
  type="success"
