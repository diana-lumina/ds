...
/>\`
  ...
  render: () => <FilterChip size="sm" selected label="Categoría" icon={<FunnelSimpleIcon />} />
  ...
  render: () => {
    ...
    const rows = [{
      ...
      label: 'Leading icon',
      render: (size: 'sm' | 'md') => <FilterChip size={size} selected label="Categoría" icon={<FunnelSimpleIcon />} />
    }] as const;
    return <div style={{
      padding: 8
    }}>\r
