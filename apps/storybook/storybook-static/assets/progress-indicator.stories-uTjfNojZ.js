...
</ProgressIndicator>`}}},render:()=>(0,A.jsxs)(E,{children:[(0,A.jsx)(m,{state:`completed`,label:`Datos personales`,icon:(0,A.jsx)(i,{})}),(0,A.jsx)(m,{state:`current`,label:`Pago`,icon:2}),(0,A.jsx)(m,{state:`upcoming`,label:`Confirmación`,icon:3})]})},F={parameters:{docs:{canvas:{sourceState:`shown`},source:{code:`<ProgressIndicator>
  <ProgressStep state="completed" label="Datos personales" icon={<CheckIcon />} />
  <ProgressStep state="error" label="Pago" icon={<WarningIcon />} />
  <ProgressStep state="upcoming" label="Confirmación" icon={3} />
</ProgressIndicator>`}}},render:()=>(0,A.jsxs)(E,{children:[(0,A.jsx)(m,{state:`completed`,label:`Datos personales`,icon:(0,A.jsx)(i,{})}),(0,A.jsx)(m,{state:`error`,label:`Pago`,icon:(0,A.jsx)(o,{})}),(0,A.jsx)(m,{state:`upcoming`,label:`Confirmación`,icon:3})]})},I={name:`All completed`,parameters:{docs:{canvas:{sourceState:`shown`},source:{code:`<ProgressIndicator>
  <ProgressStep state="completed" label="Datos personales" icon={<CheckIcon />} />
  <ProgressStep state="completed" label="Pago" icon={<CheckIcon />} />
  <ProgressStep state="completed" label="Confirmación" icon={<CheckIcon />} />
</ProgressIndicator>`}}},render:()=>(0,A.jsxs)(E,{children:[(0,A.jsx)(m,{state:`completed`,label:`Datos personales`,icon:(0,A.jsx)(i,{})}),(0,A.jsx)(m,{state:`completed`,label:`Pago`,icon:(0,A.jsx)(i,{})}),(0,A.jsx)(m,{state:`completed`,label:`Confirmación`,icon:(0,A.jsx)(i,{})})]})},L={name:`With disabled`,parameters:M,render:()=>(0,A.jsxs)(E,{children:[(0,A.jsx)(m,{state:`completed`,label:`Datos personales`,icon:(0,A.jsx)(i,{})}),(0,A.jsx)(m,{state:`current`,label:`Pago`,icon:2}),(0,A.jsx)(m,{state:`disabled`,label:`Envío`,icon:3})]})},N.parameters={...N.parameters,docs:{...N.parameters?.docs,source:{originalSource:`{
