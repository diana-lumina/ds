      ...
      gap: 16
        ...
        <div>\r
          ...
          color: '#666'
            ...
            Marca las opciones que quieres recibir. “Seleccionar todo” muestra el estado mixed.\r
          </p>\r
        </div>\r
        <div style={{
        display: 'flex',
        ...
        gap: 12
          ...
          paddingLeft: 8
            ...
            <span className={styles.label}>Notificaciones del curso (checked)</span>\r
          </label>\r
          <label className={styles.field} style={{
          paddingLeft: 8
        }}>\r
            <Checkbox id="cb-marketing" checked={marketing} onCheckedChange={value => setMarketing(value === true)} />\r
            <span className={styles.label}>Novedades y marketing (unchecked)</span>\r
          </label>\r
        </div>\r
      </div>;
  }
}`,...O.parameters?.docs?.source}}},k=[`Playground`,`AllStates`,`InContext`]}))();export{D as AllStates,O as InContext,E as Playground,k as __namedExportsOrder,T as default};