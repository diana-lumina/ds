...
/>\`
  ...
  render: () => <FloatingActionButton type="standard" floating={false} icon={<BagIcon />} aria-label="Agregar" />
...
/>\`
  ...
  render: () => <FloatingActionButton type="extended" floating={false} icon={<BagIcon />} label="Agregar" />
...
/>\`
  ...
  render: () => <FloatingActionButton type="extended" floating={false} icon={<BagIcon />} label="Agregar" disabled />
...
/>\`
  ...
  render: () => <FloatingActionButton type="extended" floating={false} icon={<BagIcon />} label="Agregar" loading />
        ...
        borderCollapse: 'collapse'
          ...
          <tbody>\r
            ...
            <tr>\r
              ...
              <td style={td}>\r
                <FloatingActionButton type="extended" floating={false} icon={<BagIcon />} label="Agregar" />\r
              </td>\r
              <td style={td}>\r
                <FloatingActionButton type="extended" floating={false} icon={<BagIcon />} label="Agregar" disabled />\r
              </td>\r
            </tr>\r
          </tbody>\r
        </table>\r
  ...
  render: () => <div style={{
    ...
    fontFamily: 'sans-serif'
      ...
      <FloatingActionButton type="extended" floating icon={<BagIcon />} label="Nuevo borrador" />\r
    </div>
