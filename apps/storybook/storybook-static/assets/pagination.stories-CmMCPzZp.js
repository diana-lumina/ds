import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{C as n,U as r}from"./iframe-CPmBFJEF.js";import{$ as i,Z as a,n as o}from"./icons-QF8wPxMP.js";import{n as s,t as c}from"./utils-D8qMR3V9.js";import{t as l}from"./icon-button-Bh3oQobN.js";import{t as u}from"./icon-button-BHD88BXq.js";import{n as d,t as f}from"./pagination-item-Df31IGXR.js";var p=e((()=>{d()})),m,h,g=e((()=>{m=`_root_z93or_1`,h={root:m}}));function _({children:e,onPrevious:t,onNext:n,previousDisabled:r=!1,nextDisabled:o=!1,previousLabel:s=`Página anterior`,nextLabel:u=`Página siguiente`,className:d,"aria-label":f=`Paginación`,...p}){return(0,v.jsxs)(`nav`,{"data-slot":`pagination`,"aria-label":f,className:c(h.root,d),...p,children:[(0,v.jsx)(l,{hierarchy:`tertiary`,size:`md`,icon:(0,v.jsx)(i,{}),"aria-label":s,disabled:r,onClick:t}),e,(0,v.jsx)(l,{hierarchy:`tertiary`,size:`md`,icon:(0,v.jsx)(a,{}),"aria-label":u,disabled:o,onClick:n})]})}var v,y=e((()=>{r(),o(),s(),u(),g(),v=n(),_.__docgenInfo={description:`Contenedor de paginación. Compone IconButton tertiary md (prev/next)\r
