...
\r
  ...
  render: () => {
    ...
    return <RadioGroup value={value} onValueChange={setValue} aria-label="Canal de contacto">\r
        ...
        <label className={styles.field}>\r
          ...
          <span className={styles.label}>No contactar (disabled)</span>\r
        </label>\r
      </RadioGroup>;
  }
}`,...k.parameters?.docs?.source}}},A=[`Playground`,`AllStates`,`WithLabels`]}))();export{O as AllStates,D as Playground,k as WithLabels,A as __namedExportsOrder,E as default};