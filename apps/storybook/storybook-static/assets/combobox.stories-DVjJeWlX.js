import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{C as n,U as r}from"./iframe-CFNdY8gy.js";import{j as i,n as a}from"./icons-ZEAiTreS.js";import{n as o,t as s}from"./utils-D8qMR3V9.js";import{A as c,O as l,j as u,k as d,t as f}from"./dist-CJdV0_Mo.js";import{t as p}from"./text-input-oAcDOiCx.js";import{t as m}from"./text-input-DbWVQkwA.js";import{n as h,t as g}from"./select.module-DsDFuNZ9.js";var _,v,y,b,x,S,C,w,T,E=e((()=>{_=`_root_jk2y1_7`,v=`_label_jk2y1_23`,y=`_supporting_jk2y1_43`,b=`_control_jk2y1_119`,x=`_input_jk2y1_189`,S=`_list_jk2y1_203`,C=`_options_jk2y1_217`,w=`_empty_jk2y1_231`,T={root:_,label:v,supporting:y,control:b,input:x,list:S,options:C,empty:w}}));function D(e,t){return t?e.find(e=>e.value===t)?.label??``:``}function O(e,t){let n=t.trim().toLocaleLowerCase(`es-MX`);return n?e.label.toLocaleLowerCase(`es-MX`).includes(n):!0}function k({label:e,supportingText:t,appearance:n=`outlined`,tone:r=`standard`,error:a=!1,disabled:o,placeholder:f,options:m,value:g,defaultValue:_,onValueChange:v,emptyText:y=`Sin resultados`,name:b,id:x,className:S,...C}){let w=A.useId(),E=A.useId(),k=x??E,M=t?`${k}-supporting`:void 0,N=a&&!o,P=A.useRef(null),F=g!==void 0,[I,L]=A.useState(_),R=F?g:I,[z,B]=A.useState(()=>D(m,R)),[V,H]=A.useState(!1),[U,W]=A.useState(0),G=A.useMemo(()=>m.filter(e=>O(e,z)),[m,z]);A.useEffect(()=>{B(D(m,R))},[m,R]),A.useEffect(()=>{W(0)},[z,V]);function K(e){F||L(e),v?.(e),B(D(m,e)),H(!1)}function q(e){G.length!==0&&W(t=>(t+e+G.length)%G.length)}function J(){let e=G[U];!e||e.disabled||K(e.value)}return(0,j.jsx)(`div`,{"data-slot":`combobox`,"data-appearance":n,"data-tone":r,"data-error":N?`true`:void 0,"data-disabled":o||void 0,className:s(T.root,S),...C,children:(0,j.jsxs)(u,{open:V,onOpenChange:H,children:[(0,j.jsx)(`label`,{htmlFor:k,className:T.label,children:e}),(0,j.jsx)(l,{asChild:!0,children:(0,j.jsx)(`div`,{ref:P,className:T.control,children:(0,j.jsx)(p,{id:k,embedded:!0,appearance:n,tone:r,error:a,disabled:o,placeholder:f,name:b,role:`combobox`,"aria-expanded":V,"aria-controls":w,"aria-autocomplete":`list`,"aria-activedescendant":V&&G[U]?`${w}-${G[U].value}`:void 0,"aria-describedby":M,autoComplete:`off`,value:z,className:T.input,onFocus:()=>{o||H(!0)},onChange:e=>{B(e.target.value),o||H(!0)},onKeyDown:e=>{e.key===`ArrowDown`?(e.preventDefault(),V?q(1):H(!0)):e.key===`ArrowUp`?(e.preventDefault(),V?q(-1):H(!0)):e.key===`Enter`?V&&G[U]&&(e.preventDefault(),J()):e.key===`Escape`&&H(!1)}})})}),t?(0,j.jsx)(`span`,{id:M,className:T.supporting,children:t}):null,(0,j.jsx)(c,{children:(0,j.jsx)(d,{"data-slot":`combobox-content`,className:s(h.content,T.list),side:`bottom`,align:`start`,sideOffset:4,onOpenAutoFocus:e=>e.preventDefault(),onCloseAutoFocus:e=>e.preventDefault(),onInteractOutside:e=>{P.current?.contains(e.target)&&e.preventDefault()},children:(0,j.jsx)(`ul`,{id:w,role:`listbox`,className:s(h.viewport,T.options),children:G.length===0?(0,j.jsx)(`li`,{className:T.empty,role:`presentation`,children:y}):G.map((e,t)=>{let n=e.value===R,r=t===U;return(0,j.jsxs)(`li`,{id:`${w}-${e.value}`,role:`option`,"aria-selected":n,"aria-disabled":e.disabled||void 0,"data-highlighted":r?``:void 0,"data-state":n?`checked`:void 0,"data-disabled":e.disabled||void 0,className:h.item,onMouseEnter:()=>{e.disabled||W(t)},onMouseDown:e=>e.preventDefault(),onClick:()=>{e.disabled||K(e.value)},children:[(0,j.jsx)(`span`,{"data-slot":`select-item-text`,children:e.label}),n?(0,j.jsx)(`span`,{className:h.itemIndicator,children:(0,j.jsx)(i,{})}):null]},e.value)})})})})]})})}var A,j,M=e((()=>{A=t(r(),1),f(),a(),o(),m(),g(),E(),j=n(),k.__docgenInfo={description:`Combobox: FormField (label + TextInput + supporting) y lista de opciones\r
