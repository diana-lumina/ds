import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{C as n,U as r}from"./iframe-CFNdY8gy.js";import{G as i,n as a}from"./icons-ZEAiTreS.js";import{n as o,t as s}from"./utils-D8qMR3V9.js";import{A as c,O as l,j as u,k as d,t as f}from"./dist-CJdV0_Mo.js";import{n as p,t as m}from"./calendar-C8tlJQRL.js";import{t as h}from"./text-input-oAcDOiCx.js";import{t as g}from"./text-input-DbWVQkwA.js";var _=e((()=>{p()})),v,y,b,x,S,C,w,T=e((()=>{v=`_root_4hr34_7`,y=`_label_4hr34_23`,b=`_supporting_4hr34_43`,x=`_control_4hr34_119`,S=`_input_4hr34_189`,C=`_trailing_4hr34_215`,w={root:v,label:y,supporting:b,control:x,input:S,trailing:C}}));function E({label:e,supportingText:t,appearance:n=`outlined`,tone:r=`standard`,error:a=!1,disabled:o,calendarLabel:c=`Abrir calendario`,onCalendarClick:l,calendarExpanded:u,nativePicker:d=!0,className:f,id:p,onClick:m,...g}){let _=D.useRef(null),v=D.useId(),y=p??v,b=t?`${y}-supporting`:void 0,x=a&&!o;function S(e){if(o)return;if(l){l(e);return}let t=_.current;if(t)try{t.showPicker?.()}catch{t.focus()}}return(0,O.jsxs)(`div`,{"data-slot":`date-field`,"data-appearance":n,"data-tone":r,"data-error":x?`true`:void 0,"data-disabled":o||void 0,className:s(w.root,f),children:[(0,O.jsx)(`label`,{htmlFor:y,className:w.label,children:e}),(0,O.jsxs)(`div`,{className:w.control,children:[(0,O.jsx)(h,{ref:_,id:y,type:`date`,embedded:!0,appearance:n,tone:r,error:a,disabled:o,"aria-describedby":b,className:w.input,...g,onClick:e=>{m?.(e),d||e.preventDefault()}}),(0,O.jsx)(`button`,{type:`button`,className:w.trailing,"aria-label":c,"aria-haspopup":l?`dialog`:void 0,"aria-expanded":l?!!u:void 0,disabled:o,tabIndex:l?0:-1,onClick:S,children:(0,O.jsx)(i,{})})]}),t?(0,O.jsx)(`span`,{id:b,className:w.supporting,children:t}):null]})}var D,O,k=e((()=>{D=t(r(),1),a(),o(),g(),T(),O=n(),E.__docgenInfo={description:`Campo de fecha: FormField (label + supporting) y TextInput type="date"\r
outlined | underline × standard | inverse. CalendarIcon trailing.\r
Por defecto abre el picker nativo; DatePicker pasa onCalendarClick.`,methods:[],displayName:`DateField`,props:{label:{required:!0,tsType:{name:`string`},description:``},supportingText:{required:!1,tsType:{name:`string`},description:``},appearance:{required:!1,tsType:{name:`union`,raw:`'outlined' | 'underline'`,elements:[{name:`literal`,value:`'outlined'`},{name:`literal`,value:`'underline'`}]},description:``,defaultValue:{value:`'outlined'`,computed:!1}},tone:{required:!1,tsType:{name:`union`,raw:`'standard' | 'inverse'`,elements:[{name:`literal`,value:`'standard'`},{name:`literal`,value:`'inverse'`}]},description:``,defaultValue:{value:`'standard'`,computed:!1}},error:{required:!1,tsType:{name:`boolean`},description:``,defaultValue:{value:`false`,computed:!1}},disabled:{required:!1,tsType:{name:`boolean`},description:``},calendarLabel:{required:!1,tsType:{name:`string`},description:`Label accesible del ícono de calendario.`,defaultValue:{value:`'Abrir calendario'`,computed:!1}},onCalendarClick:{required:!1,tsType:{name:`ReactMouseEventHandler`,raw:`React.MouseEventHandler<HTMLButtonElement>`,elements:[{name:`HTMLButtonElement`}]},description:`Si se pasa, el ícono no abre el picker nativo.`},calendarExpanded:{required:!1,tsType:{name:`boolean`},description:"`aria-expanded` del ícono cuando un popup controla la apertura."},nativePicker:{required:!1,tsType:{name:`boolean`},description:"`false` evita el date picker nativo (lo usa DatePicker).",defaultValue:{value:`true`,computed:!1}}},composes:[`Omit`]}})),A=e((()=>{k()})),j,M,N,P,ee=e((()=>{j=`_root_1b8hz_1`,M=`_anchor_1b8hz_11`,N=`_content_1b8hz_19`,P={root:j,anchor:M,content:N}}));function F(e){return`${String(e.getFullYear())}-${String(e.getMonth()+1).padStart(2,`0`)}-${String(e.getDate()).padStart(2,`0`)}`}function te(e){if(!/^\d{4}-\d{2}-\d{2}$/.test(e))return;let[t,n,r]=e.split(`-`);if(!t||!n||!r)return;let i=Number(t),a=Number(n),o=Number(r),s=new Date(i,a-1,o);if(!(s.getFullYear()!==i||s.getMonth()!==a-1||s.getDate()!==o))return s}function I({label:e,supportingText:t,appearance:n=`outlined`,tone:r=`standard`,error:i=!1,disabled:a,value:o,defaultValue:f,onValueChange:p,minDate:h,maxDate:g,locale:_=`es-MX`,calendarLabel:v,name:y,id:b,className:x,...S}){let C=L.useRef(null),[w,T]=L.useState(!1),[D,O]=L.useState(f),k=o??D;function A(e){o??O(e),p?.(e)}function j(e){A(e.target.value?te(e.target.value):void 0)}return(0,R.jsx)(`div`,{"data-slot":`date-picker`,"data-appearance":n,"data-tone":r,className:s(P.root,x),...S,children:(0,R.jsxs)(u,{open:w,onOpenChange:e=>{a||T(e)},children:[(0,R.jsx)(l,{asChild:!0,children:(0,R.jsx)(`div`,{ref:C,className:P.anchor,children:(0,R.jsx)(E,{label:e,supportingText:t,appearance:n,tone:r,error:i,disabled:a,calendarLabel:v,nativePicker:!1,calendarExpanded:w,onCalendarClick:()=>{a||T(e=>!e)},value:k?F(k):``,onChange:j,min:h?F(h):void 0,max:g?F(g):void 0,name:y,id:b})})}),(0,R.jsx)(c,{children:(0,R.jsx)(d,{"data-slot":`date-picker-content`,className:P.content,side:`bottom`,align:`start`,sideOffset:8,onOpenAutoFocus:e=>e.preventDefault(),onInteractOutside:e=>{C.current?.contains(e.target)&&e.preventDefault()},children:(0,R.jsx)(m,{value:k??null,onValueChange:e=>{A(e),T(!1)},defaultMonth:k,minDate:h,maxDate:g,locale:_})})})]})})}var L,R,ne=e((()=>{L=t(r(),1),f(),o(),_(),A(),ee(),R=n(),I.__docgenInfo={description:`Date Picker: DateField + Calendar en Popover (Radix).\r
