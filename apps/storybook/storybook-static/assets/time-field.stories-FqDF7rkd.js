import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{C as n,U as r}from"./iframe-CPmBFJEF.js";import{n as i,z as a}from"./icons-QF8wPxMP.js";import{n as o,t as s}from"./utils-D8qMR3V9.js";import{t as c}from"./text-input-BV9h3jt_.js";import{t as l}from"./text-input-4jRxLs4t.js";var u,d,f,p,m,h,g,_=e((()=>{u=`_root_9eqm3_7`,d=`_label_9eqm3_23`,f=`_supporting_9eqm3_43`,p=`_control_9eqm3_119`,m=`_input_9eqm3_189`,h=`_trailing_9eqm3_215`,g={root:u,label:d,supporting:f,control:p,input:m,trailing:h}}));function v({label:e,supportingText:t,appearance:n=`outlined`,tone:r=`standard`,error:i=!1,disabled:o,timeLabel:l=`Abrir selector de hora`,className:u,id:d,...f}){let p=y.useRef(null),m=y.useId(),h=d??m,_=t?`${h}-supporting`:void 0,v=i&&!o;function x(){if(o)return;let e=p.current;if(e)try{e.showPicker?.()}catch{e.focus()}}return(0,b.jsxs)(`div`,{"data-slot":`time-field`,"data-appearance":n,"data-tone":r,"data-error":v?`true`:void 0,"data-disabled":o||void 0,className:s(g.root,u),children:[(0,b.jsx)(`label`,{htmlFor:h,className:g.label,children:e}),(0,b.jsxs)(`div`,{className:g.control,children:[(0,b.jsx)(c,{ref:p,id:h,type:`time`,embedded:!0,appearance:n,tone:r,error:i,disabled:o,"aria-describedby":_,className:g.input,...f}),(0,b.jsx)(`button`,{type:`button`,className:g.trailing,"aria-label":l,disabled:o,tabIndex:-1,onClick:x,children:(0,b.jsx)(a,{})})]}),t?(0,b.jsx)(`span`,{id:_,className:g.supporting,children:t}):null]})}var y,b,x=e((()=>{y=t(r(),1),i(),o(),l(),_(),b=n(),v.__docgenInfo={description:`Campo de hora: FormField (label + supporting) y TextInput type="time"\r
