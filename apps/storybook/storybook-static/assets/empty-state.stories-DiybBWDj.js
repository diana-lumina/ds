...
/>`}}},render:()=>(0,w.jsx)(b,{type:`success`,title:`Solicitud enviada`,message:`Recibirás una confirmación cuando el proceso termine.`,icon:(0,w.jsx)(a,{})})},j={name:`With action`,parameters:{docs:{canvas:{sourceState:`shown`},source:{code:`<EmptyState
  type="empty"
  title="Sin resultados"
  message="Intenta con otra búsqueda o limpia los filtros."
  icon={<FolderSimpleIcon />}
  action={<Button hierarchy="primary" label="Nueva búsqueda" />}
/>`}}},render:()=>(0,w.jsx)(b,{type:`empty`,title:`Sin resultados`,message:`Intenta con otra búsqueda o limpia los filtros.`,icon:(0,w.jsx)(i,{}),action:(0,w.jsx)(u,{hierarchy:`primary`,size:`md`,label:`Nueva búsqueda`})})},M={name:`Types`,parameters:E,render:()=>{let e={fontFamily:`monospace`,fontSize:11,color:`#888`,fontWeight:600,textAlign:`left`,padding:`0 16px 12px`,borderBottom:`1px solid #eee`},t={fontFamily:`monospace`,fontSize:11,color:`#888`,fontWeight:600,textAlign:`left`,verticalAlign:`top`,padding:`16px 24px 16px 0`,borderBottom:`1px solid #f0f0f0`,whiteSpace:`nowrap`},n={verticalAlign:`top`,padding:`16px 16px`,borderBottom:`1px solid #f0f0f0`};return(0,w.jsx)(`div`,{style:{padding:8},children:(0,w.jsxs)(`table`,{style:{borderCollapse:`collapse`},children:[(0,w.jsx)(`thead`,{children:(0,w.jsxs)(`tr`,{children:[(0,w.jsx)(`th`,{style:{...e,paddingLeft:0},children:`Type`}),(0,w.jsx)(`th`,{style:e,children:`EmptyState`})]})}),(0,w.jsxs)(`tbody`,{children:[(0,w.jsxs)(`tr`,{children:[(0,w.jsx)(`td`,{style:t,children:`empty`}),(0,w.jsx)(`td`,{style:n,children:(0,w.jsx)(b,{type:`empty`,title:`Sin resultados`,message:`Intenta con otra búsqueda o limpia los filtros.`,icon:(0,w.jsx)(i,{})})})]}),(0,w.jsxs)(`tr`,{children:[(0,w.jsx)(`td`,{style:t,children:`error`}),(0,w.jsx)(`td`,{style:n,children:(0,w.jsx)(b,{type:`error`,title:`No se pudo cargar`,message:`Ocurrió un problema al obtener la información. Inténtalo de nuevo.`,icon:(0,w.jsx)(o,{})})})]}),(0,w.jsxs)(`tr`,{children:[(0,w.jsx)(`td`,{style:t,children:`success`}),(0,w.jsx)(`td`,{style:n,children:(0,w.jsx)(b,{type:`success`,title:`Solicitud enviada`,message:`Recibirás una confirmación cuando el proceso termine.`,icon:(0,w.jsx)(a,{})})})]})]})]})})}},D.parameters={...D.parameters,docs:{...D.parameters?.docs,source:{originalSource:`{
  args: {
    type: 'empty',
    title: 'Sin resultados',
    message: 'Intenta con otra búsqueda o limpia los filtros.'
