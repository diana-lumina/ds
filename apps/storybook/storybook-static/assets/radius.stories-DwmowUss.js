import{i as e}from"./preload-helper-xPQekRTU.js";import{n as t,r as n,t as r}from"./getDesignTokens-DN_V1VFA.js";import{t as i}from"./jsx-runtime-CaZkqeYb.js";function a(e){return[...e].sort(([,e],[,t])=>parseFloat(e)-parseFloat(t))}function o({varName:e}){return(0,s.jsx)(`div`,{style:{height:40,width:120,background:`#1a73e8`,borderRadius:`var(${e})`}})}var s,c,l,u;e((()=>{t(),s=i(),c={title:`Foundations/Radius`,parameters:{layout:`fullscreen`}},l={render:()=>{let e=r(`radius`),t=a(Object.entries(e).filter(([e])=>/^--radius-(\d+|full)$/.test(e)));return(0,s.jsxs)(`div`,{style:{padding:32,fontFamily:`sans-serif`},children:[(0,s.jsx)(`h1`,{children:`Radius`}),(0,s.jsx)(`div`,{style:{display:`grid`,gridTemplateColumns:`repeat(auto-fill, minmax(160px, 1fr))`,gap:24,marginTop:24},children:t.map(([e,t])=>(0,s.jsxs)(`div`,{children:[(0,s.jsx)(o,{varName:e}),(0,s.jsx)(`div`,{style:{fontFamily:`monospace`,fontSize:12,marginTop:10},children:n(e)}),(0,s.jsx)(`div`,{style:{fontFamily:`monospace`,fontSize:11,color:`#666`},children:t})]},e))})]})}},l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  render: () => {
